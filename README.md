...
[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Huvaris/MUSIC-VC)
...
```bash
$ git clone https://github.com/Huvaris/Music-VC
$ cd MusicPlayer
$ cp sample.env .env
